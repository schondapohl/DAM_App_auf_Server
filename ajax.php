...
class PageAjax extends PageRegular
{
	...
	public function run()
	{
		...
		{
            $_SESSION['pageloader'] = "userbereich";
            /*if(!isset($_SESSION['datei1']))
            {
               $_SESSION['datei1'] = $this->Input->get('qqfile');
            }
            else if(!isset($_SESSION['datei2']))
            {
                $_SESSION['datei2'] = $this->Input->get('qqfile');
            }
            else if(!isset($_SESSION['datei3']))
            {
                $_SESSION['datei3'] = $this->Input->get('qqfile');
            }*/
